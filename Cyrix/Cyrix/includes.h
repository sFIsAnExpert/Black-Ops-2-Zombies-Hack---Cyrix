...
namespace Globals
{
	...
	inline float iCircleThickness = 1.5f, iFoV = 1.25, R = 255.0f, G = 0, B = 0, A = 55.f;
	...
	inline bool bGodmode = false, bGodmodeChk = false, bLockedOn = false, bHoldingAimbot = false, bSilentAimChk = false, bSilentUnhook = false;
}
